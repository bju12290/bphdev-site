...
![A diagram representing the collision caused by the HP freeze cheat and the damage multiplier cheat targetting the same site.](/images/writing/kh3-dmg-multiplier/damage_multiplier_hp_hook_collision.png)
