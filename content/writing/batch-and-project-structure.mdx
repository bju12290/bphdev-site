...
a project structure. I try to decide what's best based on the projects requirements, but I have a tendency to take too much time trying
to find the perfect solution. Additionally, there's always common overlap in the boilerplate file structure, which lead me to a simple idea. One command
...
REM Further research into why we didn't get a shorthand symbol is warranted.
```
...
Additonally, It’s a reminder that automation doesn't always require the latest shiny framework. Sometimes, reaching for a 40-year-old tool is the fastest way to remove current friction and establish a repeatable workflow.
